...
Save in the artifact workspace profile resolved under `reference/sop-cm-pipeline.md`. Project-local: `CM Artifacts/<project-slug>-<run-id>-<YYYY-MM-DD>-experiment.md`. Shared Drive: `Experiment — <Channel / Topic> — <Client Display Name> — <YYYY-MM-DD>.docx`, uploaded without native-Google-Doc conversion.
